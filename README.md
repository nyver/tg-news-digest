...
- **Автоочистка БД** — автоматическое удаление записей истории дайджестов старше 7 дней
...
A: Да. Записи истории дайджестов (`digest_runs`) старше 7 дней автоматически удаляются. Это происходит при запуске бота и затем каждые 24 часа в фоновом режиме.
